...
__webpack_require__.d(__webpack_exports__, {
  "PointRenderer": () => (/* binding */ PointRenderer)
});
...
;// CONCATENATED MODULE: ./node_modules/three/src/scenes/Scene.js
...
;// CONCATENATED MODULE: ./node_modules/three/src/materials/PointsMaterial.js
...
;// CONCATENATED MODULE: ./node_modules/three/src/objects/Points.js
...
const Points_inverseMatrix = /*@__PURE__*/ new Matrix4();
const Points_ray = /*@__PURE__*/ new Ray();
const Points_sphere = /*@__PURE__*/ new Sphere();
const Points_position = /*@__PURE__*/ new Vector3();
...
class Points extends Object3D {
	...
	raycast( raycaster, intersects ) {
		...
		Points_sphere.copy( geometry.boundingSphere );
		Points_sphere.applyMatrix4( matrixWorld );
		Points_sphere.radius += threshold;

		if ( raycaster.ray.intersectsSphere( Points_sphere ) === false ) return;

		//

		Points_inverseMatrix.copy( matrixWorld ).invert();
		Points_ray.copy( raycaster.ray ).applyMatrix4( Points_inverseMatrix );
		...
		if ( geometry.isBufferGeometry ) {
			...
			if ( index !== null ) {
				...
				for ( let i = start, il = end; i < il; i ++ ) {
					...
					Points_position.fromBufferAttribute( positionAttribute, a );

					testPoint( Points_position, a, localThresholdSq, matrixWorld, raycaster, intersects, this );
				...
				for ( let i = start, l = end; i < l; i ++ ) {
					...
					Points_position.fromBufferAttribute( positionAttribute, i );

					testPoint( Points_position, i, localThresholdSq, matrixWorld, raycaster, intersects, this );
...
function testPoint( point, index, localThresholdSq, matrixWorld, raycaster, intersects, object ) {
	...
	const rayPointDistanceSq = Points_ray.distanceSqToPoint( point );

	if ( rayPointDistanceSq < localThresholdSq ) {

		const intersectPoint = new Vector3();

		Points_ray.closestPointToPoint( point, intersectPoint );
...
;// CONCATENATED MODULE: ./node_modules/@unovis/ts/components/leaflet-flow-map/shaders.js
const shaders_vertex = `
...
;// CONCATENATED MODULE: ./node_modules/@unovis/ts/components/leaflet-flow-map/renderer-utils.js
...
;// CONCATENATED MODULE: ./node_modules/@unovis/ts/components/leaflet-flow-map/renderer.js
